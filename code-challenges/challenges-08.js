  ...
  // write your code here
    ...
    for (const key in obj) {
      if (obj.hasOwnProperty(key)) {
        const name = key;
        const age = obj[key];
        const customerStr = `Customer Name :${name} , Age :${age}`;
        result.push(customerStr);
      }
    }
...
const getEntries = (obj) => {
  // write your code here
    ...
    // Loop through the entries and construct the strings in the desired format
    for (const [key, value] of entries) {
      // Check if the value is an array, and join the array elements into a string with commas
