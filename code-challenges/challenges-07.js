...
const objLat = (obj) => {
    // write your code here
        ...
        let formattedString = "my name is ";
      
        if (obj.firstName && obj.lastName && obj.age && obj.hobby) {
          ...
          formattedString += "I am " + obj.age + " YO, and I love " + obj.hobby + ".";
        }
...
const applicationsStatics = (arr) => {
    // write your code here
        ...
        for (let i = 0; i < arr.length; i++) {
          ...
          const { firstName, lastName, yearsOfExperience, tech } = applicant;
...
const classesAvg = (data) => {
    // write your code here
        ...
        for (let grade of data.grades) {
          for (let classItem of grade.classes) {
            let sum = 0;
            for (let score of classItem.classScores) {
              sum += score;
            }
            classItem.avg = Math.floor(sum / classItem.classScores.length);
          }
        }
